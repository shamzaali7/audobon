...
const [lead, setLead] = useState();
  return (
    <div>
      <div className="Home">
        <Link to="/">
          <span className="audobon">Audobon Society</span>
        </Link>
      </div>
      <div className="birdsT">
        Birds:
      </div>
      ...
      <main>
        <Routes>
          <Route path="/" element={<Home Birds={Birds} lead={lead} setLead={setLead} />}/>
          <Route path="/showPage/:index" element={<ShowPage Birds={Birds} lead={lead}/>}/>
        </Routes>
      </main>
    </div>
  );
